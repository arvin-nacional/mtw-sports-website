...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LogoRibbonBlock".
 */
export interface LogoRibbonBlock {
  label?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LogoRibbonBlock_select".
 */
export interface LogoRibbonBlockSelect<T extends boolean = true> {
  label?: T;
  speed?: T;
  logos?:
    | T
